...
import ArrowLeftIcon from "@/assets/svgs/icon-arrow-left-long.svg";
import ArrowRightIcon from "@/assets/svgs/icon-arrow-right-long.svg";
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-blue font-bold text-white hover:bg-coal hover:text-white focus:bg-blue focus:text-white",
